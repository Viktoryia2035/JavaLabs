...
public class DayAspect {
    ...
    @Around("execution(* "
            + "sunposition.springday.service.DayService."
            + "findAllSunriseSunset(..))")
    public Object aroundFindAllSunriseSunsetAdvice(
    ...
    @Around("execution(* "
            + "sunposition.springday.service.DayService."
            + "saveSunriseSunset(..))")
    public Object aroundSaveSunriseSunsetAdvice(
            final ProceedingJoinPoint joinPoint) throws Throwable {
    ...
    @Around("execution(* "
            + "sunposition.springday.service.DayService."
            + "findByLocation(..))")
    public Object aroundFindByLocationAdvice(
            final ProceedingJoinPoint joinPoint) throws Throwable {
    ...
    @Around("execution(* "
            + "sunposition.springday.service.DayService."
            + "findByCoordinates(..))")
    public Object aroundFindByCoordinatesAdvice(
            final ProceedingJoinPoint joinPoint) throws Throwable {
    ...
    @Around("execution(* "
            + "sunposition.springday.service.DayService."
            + "deleteDayByCoordinates(..))")
    public Object aroundDeleteDayByCoordinatesAdvice(
            final ProceedingJoinPoint joinPoint) throws Throwable {
        log.info("Entering deleteDayByCoordinates method");
        Object result = joinPoint.proceed();
        log.info("Exiting deleteDayByCoordinates method"
                + " with result: {}", result);
        return result;
    }
    ...
    @Around("execution(* "
            + "sunposition.springday.service.DayService."
            + "updateSunriseSunset(..))")
    public Object aroundUpdateSunriseSunsetAdvice(
            final ProceedingJoinPoint joinPoint) throws Throwable {
